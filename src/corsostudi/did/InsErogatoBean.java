...
public class InsErogatoBean {
    ...
    private String creditiModFromInsErogato;
	...
	public InsErogatoBean() {
		...
		this.creditiModFromInsErogato = null;
	...
	public String getCreditiModFromInsErogato() {
		return creditiModFromInsErogato;
	}

	public void setCreditiModFromInsErogato(String creditiModFromInsErogato) {
		this.creditiModFromInsErogato = creditiModFromInsErogato;
	}
